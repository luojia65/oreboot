...
unsafe fn dram_vol_set(#[allow(unused)] dram_para: &mut dram_parameters) {
...
fn auto_set_timing_para(para: &mut dram_parameters) {
    ...
    let mut tccd: u32 = 0; // 88(sp) // FIXME value assigned to this variable is never read
    ...
    #[allow(unused_assignments)]
    let mut trtp: u32 = 0; // 64(sp) // FIXME value assigned to this variable is never read
    ...
    if para.dram_tpr13 & 0x2 != 0 {
        ...
        twtr = (para.dram_tpr1 >> 20) & 0x7; // [22:20]
                                             // trtp = (para.dram_tpr1 >> 15) & 0x1f; // [19:15]  // FIXME this parameter is unused
                                             // twr = (para.dram_tpr1 >> 11) & 0xf; // [14:11]  // FIXME this parameter is unused
    ...
    // let dmr3 = para.dram_mr3; // FIXME this parameter is unused
        ...
        */
        ...
        //	L57:
        {
            ...
            twtp = tcwl + 2 + twtr as u32; // WL+BL/2+tWTR
                                           // trd2wr = tcwl + 2 + twr as u32; // WL+BL/2+tWR // FIXME this parameter is unused
